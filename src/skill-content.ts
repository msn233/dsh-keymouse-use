...
export const KEYMOUSE_SKILL_DESCRIPTION =
  '键鼠控制工具：用 SendInput 模拟真实键盘/鼠标输入、截屏、查询与置顶窗口，用于桌面自动化（打开应用、登录、点击、输入、拖拽、滚动、截图观察、窗口定位/置顶）。';

export const KEYMOUSE_SKILL_WHEN_TO_USE =
  '任何需要模拟真实键盘按下/抬起、鼠标点击/移动/滚轮、输入文字或操作前台窗口的自动化任务。';
